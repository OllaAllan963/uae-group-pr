  ...
  companies: Array<ICompany> = [
    {
      ...
      titleAr: 'الإمارات العربية المتحدة للإستثمار والتنمية',
    ...
    },
    {
      ...
      titleAr: 'الإمارات العربية المتحدة الدولية للعقارات',
      ...
      descriptionAr: 'التابعة لمجموعة الإمارات العربية المتحدة المرموقة ، هي شركة عقارية رائدة متخصصة في توفير فرص سكنية وتجارية واستثمارية فاخرة في جميع أنحاء الإمارات العربية المتحدة. مع تركيزنا على الجودة والنزاهة والابتكار، نربط عملائنا بعقارات تُجسّد الفخامة والقيمة العالية والإمكانات المستدامة.',
      ...
      description1Ar: "تعد شركة الإمارات العربية المتحدة الدولية للعقارات رائدة في مجال إدارة العقارات والوساطة والاستثمار في الأراضي، وتقدم خدمات مصممة خصيصًا للشراء والبيع ورعاية العقارات بشفافية ودقة.",
    ...
    },
    {
      ...
      descriptionAr: "تقدم شركة الإمارات العربية المتحدة لتخليص المعاملات خدمات إدارة وتخليص ومتابعة المستندات على مدار الساعة طوال أيام الأسبوع في جميع الدوائر الحكومية. كما نقدم خدمات سكرتارية شاملة، وخدمات السفر، وتنسيق الاجتماعات، لتعزيز كفاءة الأعمال."
    }
  ];
